...
public class Mahasiswa {
    ...
    public static void main(String[] args) {
        ...
        Mahasiswa.MahasiswaBaru mahasiswaBaru = mahasiswa.new MahasiswaBaru("Dwi Ayu Lestari", 19, 22166002);
        mahasiswaBaru.displayInfo();

        Mahasiswa.MahasiswaLama mahasiswaLama = mahasiswa.new MahasiswaLama("Anisa", 23, 2020);
